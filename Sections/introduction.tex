...
\begin{frame}{because the raw materials are cheap}
    ...
    \begin{alertblock}{natural gas (95\% $CH_4$ + 3\% $C_2H_6$)}
        alternative source(shale gas of US Gulf cost). \cite{noauthor_composition_nodate}
...
\begin{frame}{Because PO are versatile}
    ...
    PE density \rightarrow$ $\chi_x$  $\rightarrow$ HDPE pipes vs LDPE films \\ 
    PP tacticity $\rightarrow$ $\chi_x$ $\rightarrow$ PP $\rho$ 
    \end{alertblock}
